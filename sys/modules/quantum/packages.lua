...
function Packages:downloadList()
	local packages = {
		[ 'develop-1.8' ] = 'https://raw.githubusercontent.com/kepler155c/quantum-apps/develop-1.8/packages.list',
		[ 'master-1.8' ] = 'https://raw.githubusercontent.com/kepler155c/quantum-apps/master-1.8/packages.list',
	}
