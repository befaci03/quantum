...
local function loadComponents()
	local function load(name)
		local s, m = Util.run(_ENV, 'sys/modules/quantum/ui/components/' .. name .. '.lua')
		if not s then
			error(m)
		end
	...
	local components = fs.list('sys/modules/quantum/ui/components')
